...
FfxErrorCode ffxFsr2ContextCreate(FfxFsr2Context* context, const FfxFsr2ContextDescription* contextDescription) { return FFX_ERROR_BACKEND_API_ERROR; }
FfxErrorCode ffxFsr2ContextDestroy(FfxFsr2Context* context) { return FFX_ERROR_BACKEND_API_ERROR; }
FfxErrorCode ffxFsr2ContextDispatch(FfxFsr2Context* context, const FfxFsr2DispatchDescription* dispatchDescription) { return FFX_ERROR_BACKEND_API_ERROR; }
